...
def main():
    """Check command line arguments and dispatches according
    to the type of paper identifiers (pmid, DOI or ISBN)"""
    if len(sys.argv) >= 2:
        for pid in sys.argv[1:]:
            publicationId = pid.strip()
...
def doi2bibtex(doi: str) -> None:
    ...
    """
    try:
        response = fetchBibtexFromDOI(doi)
        bibtex_content = addNewlinesToBibtexFromDOI(response)
...
def fetchBibtexFromDOI(doi: str) -> str:
    ...
    with request.urlopen(req) as resp:
        if resp.code == 200:
            ...
            raise Exception("dx.doi.org is not responding")
...
def fetchXMLfromPubmed(pmid: str) -> str:
    ...
    with request.urlopen(url) as resp:
        if resp.code == 200:
            ...
            raise Exception("eutils.ncbi.nlm.nih.gov is not responding")
...
def parsePubmedXML(pmid: str, xml: str) -> Reference:
    ...
    title = currElem.text if (currElem is not None) else ""
    ref.title = title[:-1] if title[-1] == "." else title
...
uni2tex = {
    ...
    "\uD63C": "{$\\mbfitsansA$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP A
    "\uD63D": "{$\\mbfitsansB$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP B
    "\uD63E": "{$\\mbfitsansC$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP C
    "\uD63F": "{$\\mbfitsansD$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP D
    "\uD640": "{$\\mbfitsansE$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP E
    "\uD641": "{$\\mbfitsansF$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP F
    "\uD642": "{$\\mbfitsansG$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP G
    "\uD643": "{$\\mbfitsansH$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP H
    "\uD644": "{$\\mbfitsansI$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP I
    "\uD645": "{$\\mbfitsansJ$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP J
    "\uD646": "{$\\mbfitsansK$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP K
    "\uD647": "{$\\mbfitsansL$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP L
    "\uD648": "{$\\mbfitsansM$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP M
    "\uD649": "{$\\mbfitsansN$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP N
    "\uD64A": "{$\\mbfitsansO$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP O
    "\uD64B": "{$\\mbfitsansP$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP P
    "\uD64C": "{$\\mbfitsansQ$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP Q
    "\uD64D": "{$\\mbfitsansR$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP R
    "\uD64E": "{$\\mbfitsansS$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP S
    "\uD64F": "{$\\mbfitsansT$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP T
    "\uD650": "{$\\mbfitsansU$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP U
    "\uD651": "{$\\mbfitsansV$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP V
    "\uD652": "{$\\mbfitsansW$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP W
    "\uD653": "{$\\mbfitsansX$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP X
    "\uD654": "{$\\mbfitsansY$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP Y
    "\uD655": "{$\\mbfitsansZ$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC CAP Z
    "\uD657": "{$\\mbfitsansb$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC B
    "\uD658": "{$\\mbfitsansc$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC C
    "\uD659": "{$\\mbfitsansd$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC D
    "\uD656": "{$\\mbfitsansa$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC A
    "\uD65A": "{$\\mbfitsanse$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC E
    "\uD65B": "{$\\mbfitsansf$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC F
    "\uD65C": "{$\\mbfitsansg$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC G
    "\uD65D": "{$\\mbfitsansh$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC H
    "\uD65E": "{$\\mbfitsansi$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC I
    "\uD65F": "{$\\mbfitsansj$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC J
    "\uD660": "{$\\mbfitsansk$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC K
    "\uD661": "{$\\mbfitsansl$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC L
    "\uD662": "{$\\mbfitsansm$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC M
    "\uD663": "{$\\mbfitsansn$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC N
    "\uD664": "{$\\mbfitsanso$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC O
    "\uD665": "{$\\mbfitsansp$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC P
    "\uD666": "{$\\mbfitsansq$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC Q
    "\uD667": "{$\\mbfitsansr$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC R
    "\uD668": "{$\\mbfitsanss$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC S
    "\uD669": "{$\\mbfitsanst$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC T
    "\uD66A": "{$\\mbfitsansu$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC U
    "\uD66B": "{$\\mbfitsansv$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC V
    "\uD66C": "{$\\mbfitsansw$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC W
    "\uD66D": "{$\\mbfitsansx$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC X
    "\uD66E": "{$\\mbfitsansy$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC Y
    "\uD66F": "{$\\mbfitsansz$}",  # MATHEMATICAL SANS-SERIF BOLD ITALIC Z
    ...
    "\uD6B9": "{$\\mathbf{\\vartheta}$}",  # MATHEMATICAL BOLD CAPITAL THETA
    ...
    "\uD6F3": "{$\\mathmit{\\vartheta}$}",  # MATHEMATICAL ITALIC CAPITAL THETA
